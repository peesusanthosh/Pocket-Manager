...
// ...
    ...
    public void signUpUser(View view) {
        if(useremail.getText().toString().length()==0 || userpassword.getText().toString().length()==0||userfullname.getText().length()==0){
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                User user = new User(userfullname.getText().toString(),userpassword.getText().toString());
    ...
    private void findViewByIds() {
        userfullname= (EditText)findViewById(R.id.txtboxuserfullname);
